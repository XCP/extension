...
// Compatibility layer
import { verifyLooseBIP137 } from '@/core/blockchain/bitcoin/messageVerifier/compatibility/loose-bip137';
import { verifyBIP137 } from '@/core/blockchain/bitcoin/messageVerifier/specs/bip137';

// Spec-compliant verifiers
import { verifyBIP322 } from '@/core/blockchain/bitcoin/messageVerifier/specs/bip322';
import { verifyLegacy } from '@/core/blockchain/bitcoin/messageVerifier/specs/legacy';
import type { VerificationOptions, VerificationResult } from '@/core/blockchain/bitcoin/messageVerifier/types';
import { detectAndNormalizeSignature, validateMessage, } from '@/core/blockchain/bitcoin/messageVerifier/utils';
