...
import type { VerificationResult } from '@/core/blockchain/bitcoin/messageVerifier/types';
import { getAddressType, hashMessage, parseSignatureFlag, recoverPublicKey } from '@/core/blockchain/bitcoin/messageVerifier/utils';
