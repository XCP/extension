...
function fromApiDecode(messageData: Record<string, unknown>): DescribableMessage {
  ...
  return {
    ...
    text: (messageData.text ?? messageData.description) as string | undefined,
    ...
    quantityByPrice: messageData.quantity_by_price,
    maxMintPerTx: messageData.max_mint_per_tx,
    maxMintPerAddress: messageData.max_mint_per_address,
    hardCap: messageData.hard_cap,
    softCap: messageData.soft_cap,
    premintQuantity: messageData.premint_quantity,
    startBlock: num('start_block'),
    endBlock: num('end_block'),
    softCapDeadlineBlock: num('soft_cap_deadline_block'),
    mintedAssetCommissionInt: messageData.minted_asset_commission_int,
    burnPayment: messageData.burn_payment as boolean | undefined,
    poolQuantity: messageData.pool_quantity,
    lockDescription: messageData.lock_description as boolean | undefined,
    lockQuantity: messageData.lock_quantity as boolean | undefined,
    format,
    numeric,
    name,
  };
