...
export interface ComposeRequest {
  id: string;
  type: 'send' | 'mpma' | 'order' | 'dispenser' | 'dispense' | 'fairminter' | 'fairmint' | 'dividend' | 'sweep' | 'btcpay' | 'cancel' | 'dispenser-close-by-hash' | 'bet' | 'broadcast' | 'attach' | 'detach' | 'move-utxo' | 'move' | 'destroy' | 'issuance' | 'issue-supply' | 'lock-supply' | 'reset-supply' | 'transfer' | 'update-description' | 'lock-description';
  origin: string;
  params: any;
  timestamp: number;
}
