...
export async function composeTransaction(
  ...
  paramsObj: any,
  sourceAddress: string,
  sat_per_vbyte: number, // Now a required parameter
  signal?: AbortSignal
): Promise<ApiResponse> {
  ...
  const params = new URLSearchParams({
    ...paramsObj,
    sat_per_vbyte: sat_per_vbyte.toString(), // Directly use the required parameter
...
export async function composeBet(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('bet', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeBroadcast(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('broadcast', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeBTCPay(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('btcpay', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeBurn(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('burn', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeCancel(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('cancel', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeDestroy(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('destroy', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeDispenser(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('dispenser', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeDispense(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('dispense', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeDividend(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('dividend', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeIssuance(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('issuance', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeMPMA(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('mpma', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeOrder(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('order', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeSend(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('send', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeSweep(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('sweep', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeFairminter(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('fairminter', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeFairmint(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('fairmint', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeAttach(options: ComposeOptions): Promise<ApiResponse> {
  ...
  return composeTransaction('attach', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
...
export async function composeDetach(options: ComposeOptions): Promise<ApiResponse> {
  const { sourceAddress, destination, sat_per_vbyte, signal } = options;
  const paramsObj: any = {
    destination,
    sat_per_vbyte: sat_per_vbyte.toString(),
  };
  return composeTransaction('detach', paramsObj, sourceAddress, sat_per_vbyte, signal);
}

export async function composeMovetoutxo(options: ComposeOptions): Promise<ApiResponse> {
  const { sourceAddress, destination, utxo_value, sat_per_vbyte, signal } = options;
  const paramsObj: any = {
    destination,
    sat_per_vbyte: sat_per_vbyte.toString(),
    ...(utxo_value !== undefined && { utxo_value: utxo_value.toString() }),
  };
  return composeTransaction('move', paramsObj, sourceAddress, sat_per_vbyte, signal);
}
