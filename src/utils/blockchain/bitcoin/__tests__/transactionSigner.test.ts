...
describe('Transaction Signer Utilities', () => {
  ...
  const mockUtxo = {
    ...
    scriptPubKeyHex: '76a914' + pubKeyHashHex + '88ac', // P2PKH script with our pubkey hash
  ...
  describe('signTransaction', () => {
    ...
    it('should throw error when UTXOs is null', async () => {
      mockFetchUTXOs.mockResolvedValue(null);
    ...
    it('should throw error for invalid input without txid', async () => {
      ...
      // Mock getUtxoByTxid to return null for the all-zero txid
    ...
    it('should throw error when UTXO not found for input', async () => {
      mockFetchUTXOs.mockResolvedValue([mockUtxo]);
      mockGetUtxoByTxid.mockReturnValue(null);
