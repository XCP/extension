...
describe("AssetIcon", () => {
  ...
  describe("Basic Rendering", () => {
    it("should render with default props", () => {
      ...
      expect(image).toHaveAttribute("src", "https://cdn.xcp.io/img/icon/XCP");
  ...
  describe("Styling and Classes", () => {
    it("should apply custom className", () => {
      const { container } = render(
        <AssetIcon asset="XCP" className="custom-class" />,
      );
  ...
  describe("Edge Cases and Error Handling", () => {
    it("should handle empty asset name", () => {
      ...
      expect(image).toHaveAttribute("src", "https://cdn.xcp.io/img/icon/");
    });
  ...
  describe("Image URL Generation", () => {
    ...
    it("should handle asset names with spaces", () => {
      ...
      expect(image).toHaveAttribute(
        "src",
        "https://cdn.xcp.io/img/icon/TEST COIN",
      );
    });
  });
          ...
          fc
            ...
            .filter(
              (s: string) =>
                ...
                !s.includes('"') &&
                !s.includes("'"),
            ), // Filter out problematic characters for testing
          (asset: string) => {
        ...
        fc.property(
          fc.oneof(
            ...
            fc
              ...
              .map((n: number) => Math.floor(n / 4) * 4), // Ensure divisible by 4
          ),
          (size: "sm" | "md" | "lg" | number) => {
            const { container } = render(
              <AssetIcon asset="TEST" size={size} />,
            );
            const wrapper = container.firstChild as HTMLElement;
            ...
            if (typeof size === "string") {
              ...
              expect(wrapper).toHaveStyle(
                `width: ${expectedPixels}px; height: ${expectedPixels}px`,
              );
            } else {
              expect(wrapper).toHaveStyle(
...
describe("AssetIconWithFallback", () => {
  ...
  it("should apply correct size styles", () => {
    const { container } = render(
      <AssetIconWithFallback asset="XCP" size="sm" />,
    );
  ...
  it("should apply custom className", () => {
    const { container } = render(
      <AssetIconWithFallback asset="XCP" className="custom-class" />,
    );
  ...
  it("should handle custom numeric sizes", () => {
    const { container } = render(
      <AssetIconWithFallback asset="XCP" size={64} />,
    );
  ...
  describe("Security", () => {
    it("should handle potentially dangerous asset names safely", () => {
      const { container } = render(
        <AssetIconWithFallback asset="<script>alert('xss')</script>" />,
      );
    ...
    it("should generate valid fallback for various asset names", () => {
      ...
      fc.assert(
        fc.property(
          ...
          (asset: string) => {
            const { container } = render(
              <AssetIconWithFallback asset={asset} />,
            );
            const wrapper = container.firstChild as HTMLElement;
