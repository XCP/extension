...
describe('WalletMenu', () => {
  ...
  it('should navigate to show passphrase page for mnemonic wallet', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/keychain/secrets/show-passphrase/wallet-1');
  });
  ...
  it('should navigate to show private key page for private key wallet', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/keychain/secrets/show-private-key/wallet-2');
  });
  ...
  it('should navigate to remove wallet page when clicked', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/keychain/wallets/remove/wallet-1');
  });
