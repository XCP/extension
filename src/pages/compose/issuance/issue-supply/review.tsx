...
export const ReviewIssuanceIssueSupply = ({
  ...
  // Get divisibility from the API response
  const isDivisible = result.params.asset_info.divisible;

  // Helper to format amounts based on divisibility
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        {/* Current Supply */}
        <div className="space-y-1">
          <span className="font-semibold text-gray-700">Current Supply:</span>
          <div className="bg-gray-50 p-2 rounded text-gray-900">
            {currentSupply}
          </div>
        </div>

        {/* Supply After Issuance */}
        <div className="space-y-1">
          <span className="font-semibold text-gray-700">After Issuance:</span>
          <div className="bg-gray-50 p-2 rounded text-gray-900">
            {newTotalSupply}
          </div>
        </div>
