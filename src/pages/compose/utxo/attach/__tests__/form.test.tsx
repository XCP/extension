...
describe('UtxoAttachForm', () => {
   ...
   *
   * The assertion moved with the behaviour. Checking the button here would now
   * pass for the wrong reason, because typing "-5" leaves a perfectly valid
   * "5" behind; what is worth pinning is that the sign never lands.
   */
