/**
 * Import Test Address Page Tests (/keychain/setup/import-test-address)
 *
...
// In CI/production, the page immediately redirects to /keychain/wallets/add before any tests can run
walletTest.describe.skip('Import Test Address Page (/keychain/setup/import-test-address)', () => {
  ...
  async function navigateToImportTestAddress(page: any): Promise<boolean> {
    ...
    await page.goto(`${baseUrl}/keychain/setup/import-test-address`);
