/**
 * Show Passphrase Page Tests (/keychain/secrets/show-passphrase/:walletId)
 *
...
walletTest.describe('Show Passphrase Page (/secrets/show-passphrase)', () => {
  ...
  walletTest('handles invalid wallet ID', async ({ page }) => {
    await page.goto(page.url().replace(/\/index.*/, '/keychain/secrets/show-passphrase/invalid-wallet-id-12345'));
    await page.waitForLoadState('networkidle');
